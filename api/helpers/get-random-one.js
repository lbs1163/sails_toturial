var quotes = ["Chuck Norris doesn't call the wrong number. You answer the wrong phone.",
...
module.exports = {
  friendlyName: 'Get random one',
  description: 'Get a random quote',
  inputs: {},
  exits: {

    success: {
      outputFriendlyName: 'Random quote',
      outputDescription: 'A random quote from json file',
    }
